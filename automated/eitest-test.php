...
if ($argc != 2) {
    ...
    $GLOBALS["ipclient"] = $argv[1];
}

if(strlen($GLOBALS["ipclient"]) <2){
    exit("NO IP");
}

echo $GLOBALS["ipclient"];
$GLOBALS["user-agent"] = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36";
